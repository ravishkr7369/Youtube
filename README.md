...
**ReactTube** is a modern full-stack video-sharing and social media platform built with React, Express.js, MongoDB, and JWT-based authentication. It delivers a polished user experience for video discovery, playback, subscriptions, playlists, likes, comments, upload management, and personal channel administration.
...
**Resume bullets**
- Developed a full-stack video-sharing web app using React 19, Vite, Tailwind CSS, Express, MongoDB, and JWT-based authentication.
